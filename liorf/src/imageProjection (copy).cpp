...
public:
    ...
    void allocateMemory()
    {
        //std::cout << "how is it going 1" << std::endl;
        laserCloudIn.reset(new pcl::PointCloud<PointXYZIRT>());
        //std::cout << "how is it going 2" << std::endl;
    ...
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        else if (sensor == SensorType::OUSTER)
        {
            ...
            //std::cout << "tmpOusterCloudIn->size() : " << tmpOusterCloudIn->size() << std::endl;
            ...
            for (size_t i = 0; i < tmpOusterCloudIn->size(); i++)
            {
                ...
                /*
                cout << "src.x         : " << src.x << endl;
                cout << "src.y         : " << src.y << endl;
                cout << "src.z         : " << src.z << endl;
                cout << "src.intensity : " << src.intensity << endl;
                cout << "src.ring      : " << src.ring << endl;                
                cout << "src.time      : " << src.t * 1e-9f << endl;
                cout << " ============== " << endl;
                */
    ...
    bool deskewInfo()
    {
        //std::cout << "where are you11 \n" << std::endl;
        std::lock_guard<std::mutex> lock1(imuLock);
        //std::cout << "where are you111 \n" << std::endl;
        std::lock_guard<std::mutex> lock2(odoLock);
        //std::cout << "where are you1111 \n" << std::endl;
    ...
    void odomDeskewInfo()
    {
        ...
        if (odomQueue.back().header.stamp.toSec() < timeScanEnd)      //LSB
            return;                                                       //LSB
        ...
        for (int i = 0; i < (int)odomQueue.size(); ++i)
        {
            ...
            if (ROS_TIME(&endOdomMsg) < timeScanEnd)                  //LSB
                continue;                                             //LSB
            else                                                      //LSB
                break;                                                //LSB
        }
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            //std::cout << "range : " << laserCloudIn->points[i].x << std::endl;

            float range = common_lib_->pointDistance(thisPoint);
            
            if (range < lidarMinRange || range > lidarMaxRange)                
                continue;
            //std::cout << "where are you 1\n" << std::endl;

            int rowIdn = laserCloudIn->points[i].ring;
            if (rowIdn < 0 || rowIdn >= N_SCAN)                
                continue;
            //std::cout << "where are you 2\n" << std::endl;

            if (rowIdn % downsampleRate != 0)                
                continue;
            //std::cout << "where are you 3\n" << std::endl;

            if (i % point_filter_num != 0)                
                continue;
            //std::cout << "where are you 4\n" << std::endl;
