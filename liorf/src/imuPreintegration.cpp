...
public:
    ...
    IMUPreintegration()
    {
        ...
        // Add these lines to initialize the publisher
        pubDisableFlag = nh.advertise<std_msgs::Char>("liorf_disable_flag", 1);
    ...
    bool failureDetection(const gtsam::Vector3& velCur, const gtsam::imuBias::ConstantBias& biasCur)
    {
        ...
        if (vel.norm() > 30)
        {
            ...
            std::cout << "velCur.x()" << velCur.x() << std::endl;
            std::cout << "velCur.y()" << velCur.y() << std::endl;
            std::cout << "velCur.z()" << velCur.z() << std::endl;

            std_msgs::Char disableFlagMsg;
            disableFlagMsg.data = 1; // Set to '1' when there's a failure
            pubDisableFlag.publish(disableFlagMsg);
            return true;
        }
        ...
        // Publish '0' when everything is normal
        std_msgs::Char disableFlagMsg;
        disableFlagMsg.data = 0;
        pubDisableFlag.publish(disableFlagMsg);
