...
namespace navigation_interface {
    ...
    void Publisher::publish_imu(GPS_INS_NAV nav_stuct){
        ...
        //LSB temp [230726] - init
        // Add timestamp (secs and nsecs)
        imu_data.header.stamp = ros::Time::now(); // Current time
        imu_data.header.frame_id = "imu_link"; // Set frame_id to "imu_link"
        //LSB temp [230726] - finish
