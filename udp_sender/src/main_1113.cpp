...
int main(int argc, char **argv) {
    ...
    while (ros::ok()) {
        ...
        //std::cout << " count           :: " << (data.north - (udp_data.north + init_north))<< std::endl;

        //std::cout << " Nav east        :: " << (udp_data.east + init_east)<< std::endl;
        //std::cout << " Nav north       :: " << (udp_data.north + init_north)<< std::endl;
